...
const ResetPinSecond = ({ OnClose, OnComplete }) => {
        ...
        <View style={styles.body}>
          ...
          <View style={styles.mainContent}>
            <View style={{ justifyContent: 'center', alignItems: 'flex-start', marginBottom: 10, marginTop: 25, marginLeft: 25, marginRight: 25 }}>
              <Text style={{ color: '#0F0E43', fontFamily: font.BOLD, fontSize: 20 }}>Confirm  Pin </Text>
              <Text style={{ marginRight: 25, color: lightTheme.BLACK_TEXT_COLOR, fontFamily: 'Poppins-Light', fontSize: 16 }}>Let’s set your PIN for all your transactions.  </Text>
            </View>

            <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, }}>
              <Text style={{ color: '#0F0E43', fontFamily: font.BOLD, fontSize: 20, marginBottom: 20 }}>Confirm Transaction PIN</Text>
