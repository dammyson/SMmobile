...
export default class ResetPin_First extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    const { OnClose,  } = this.props;
      ...
      <View style={styles.mainContent}>
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center', marginBottom: 10, marginTop: 25, marginLeft: 25, marginRight: 25 }}>
          <Text style={{ color: '#0F0E43', fontFamily: 'Poppins-SemiBold', fontSize: 14 }}>Create Transaction  Pin </Text>
          <Text style={{ marginLeft: 25, marginRight: 25, textAlign: 'center', color: '#2E2E2E', fontFamily: 'Poppins-Light', fontSize: 12 }}>You will need this to complete your transactions. So don’t forget it.  </Text>
        </View>
