...
const GiveAwayShare = ({ purpose, code, onDownload, onShare , onClose}) => {
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center', }}>
                <ViewShot style={{ width: 305, height: 305, borderWidth:1 }} ref={viewShotRef} options={{ format: 'png', quality: 0.9 }} >
                    ...
                    <ImageBackground
                        ...
                        source={require('../../assets/code_template.png')}
                    >

                        <View style={{flex:1 , marginRight: 15, marginLeft: 15, justifyContent:'center', alignItems:'center',}}>
