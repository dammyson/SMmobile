...
export default class Error extends React.Component {
  ...
  return (
    <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#D60727', '#6B0414']} style={styles.backgroundImage} block iconLeft>
    <View style={{ flex: 1.6 }}>
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ color: '#FFF', fontSize: 23, marginBottom: 20, fontWeight: '900' }}>Unsuccessful</Text>
            <LottieView style={{ height:250, }} source={require('../../assets/ncorrect.json')} autoPlay   loop={false}/>
        </View>
    </View>

    <View style={{ flex: 1, backgroundColor: '#fff', justifyContent: 'center', borderRadius: 15 }}>
        <View style={{ alignItems: 'center' }}>
  <Text style={{ color: '#D60727', fontSize: 16, fontWeight: '500' }}> Dear {fname} {lname}</Text>
