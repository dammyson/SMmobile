...
export default class ResetPin_Second extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    const { OnClose,  } = this.props;
      ...
      <View style={styles.mainContent}>
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center', marginBottom: 10, marginTop: 25, marginLeft: 25, marginRight: 25 }}>
          <Text style={{ color: '#0F0E43', fontFamily: 'Poppins-SemiBold', fontSize: 14 }}>Verify Transaction  Pin </Text>
          <Text style={{ marginLeft: 25, marginRight: 25, textAlign: 'center', color: '#2E2E2E', fontFamily: 'Poppins-Light', fontSize: 12 }}>Please enter the pin you previously enter.  </Text>
        </View>
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20, }}>
          <OTPInputView
            ...
            onCodeChanged={code => { this.getCodeTwo(code) }}
            autoFocusOnLoad
