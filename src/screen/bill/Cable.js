...
export default class Cable extends Component {
    ...
    getProductRequest(product) {
        ...
        this.setState({ loading: true, account: product });
        fetch(URL.urlthree + '/utility/cable/' + product, {
            method: 'GET', headers: {
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.mainbody}>
                        ...
                        <View style={styles.textInputContainer}>
                            <Text style={styles.actionbutton}>Poducts </Text>
                        ...
                        <View style={styles.textInputContainer}>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={[styles.actionbutton, { marginRight: 10 }]}>Cable Tv Identification</Text>
                                <View style={{ justifyContent: 'center' }}>
                                    <Tooltip popover={<Text style={{ fontSize: 10, color: '#fff' }}>Smart card number or Decoder number</Text>}>
                                        <Icon
                                            name="info"
                                            size={30}
                                            type='material'
                        ...
                        <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#4b47b7', '#0f0e43']} style={styles.buttonContainer} block iconLeft>
                            <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }} onPress={() => this.showPinOption()} >
...
showPinOption(){
    ...
    if (custormer_code == '' || amount == '', product_name == 'Select product') {
        Alert.alert('Validation failed', ' Fields cannot be empty', [{ text: 'Okay' }])
        return
    }
                ...
                {this.state.product_list.length < 1 ?
                    ...
                    <View style={{ paddingTop: 1, paddingBottom: 10, flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Icon
                            ...
                            color={color.primary_color}
                        />
                        <Text style={{ margin: 20, fontSize: 12, color:color.primary_color, fontFamily: 'Poppins-SemiBold', }}>Please select a product to see billers </Text>
                    </View> :
