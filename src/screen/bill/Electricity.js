...
export default class Electricity extends Component {
    ...
    getProductRequest(product) {
        ...
        fetch(URL.urlthree + '/utility/' + product, {
            method: 'GET', headers: {
                    ...
                    <View style={styles.mainbody}>
                        ...
                        <View style={styles.textInputContainer}>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={[styles.actionbutton, { marginRight: 10 }]}>Meter Number</Text>
                                <View style={{ justifyContent: 'center' }}>
                                    <Tooltip popover={<Text style={{ fontSize: 10, color: '#fff' }}>Meter Number</Text>}>
                                        <Icon
                                            name="info"
                                            size={30}
                                            type='material'
