    ...
    fetch(URL.urltwo + '/wallet/withdrawal', {
      ...
      .then(res => {
        ...
        if(res.data.status == 'success'){
          ...
          this.setState({ view_error: true,   operation_message: res.message })
        }
      })
      .catch((error) => {
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', fontWeight: '900', marginTop: 20 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center', flex: 1 }}>
              <Text style={{ color: "#000", fontWeight: '900', fontSize: 16, }}>Withdraw to bank</Text>
            </View>
        ...
        >
          <ModalContent style={styles.smodal}>
            ...
            <View style={{ flex: 1,  }}>
             ...
             <Text style={{ color: '#FFF', fontSize:13, fontWeight: '500' }}>Your withdrawal of NGN {this.state.amount} was successful </Text>
        ...
        >
          <ModalContent style={styles.smodal}>
            ...
            <View style={{ flex: 1,  }}>
             ...
             <View style={{ flex: 1, justifyContent: 'center' , alignItems:'center'  }}>
             <Text style={{ color: '#FFF', fontSize:16, fontWeight: '500' }}>Dear {this.state.data.user_id} </Text>
             <Text style={{ color: '#FFF', fontSize:13, fontWeight: '500' }}>Your withdrawal of NGN {this.state.amount} was unsuccessful </Text>
             <Text style={{ color: '#FFF', fontSize:13, fontWeight: '500' }}>{this.state.operation_message} </Text>
