...
export default class MDonate extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    addDonationProcess() {
        Moment.locale('en');
        const { qty, amount, wallet, name, auth, } = this.state
        console.warn(wallet);
        if (qty == 0 || amount == 0) {
        ...
        var Dbody = JSON.stringify({
            ...
            to: "2025-07-30",
            is_donor_to_claim: is_donor_to_claim
        });
            ...
            <View style={styles.backgroundImage}>
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.mainbody}>
                        ...
                        <View style={styles.textInputContainer}>
                            <Text style={styles.actionbutton}>Reach</Text>
                            <View style={styles.input}>
                                <TextInput
                        ...
                        <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#4b47b7', '#0f0e43']} style={styles.buttonContainer} block iconLeft>
                            <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }} onPress={() => this.setState({ pin: true })} >
                                <Text style={{ fontFamily: 'Poppins-SemiBold', color: '#fdfdfd', fontSize: 14 }}>Generate Code</Text>
                            </TouchableOpacity>
                        </LinearGradient>
                        {this.state.is_donor == 'true' ?
                            <View style={{ margin: 10, justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ marginBottom: 10, color: '#3e3e3e', fontFamily: 'Poppings-Italics', opacity: 0.7, marginTop: 5, fontSize: 12, }}>Note: This Giveaway is only redemable at your outlet</Text>
                            </View>
                            : null
                        }
