...
export default class Limits extends Component {
    ...
    updateDonationProcess() {
        ...
        var Dbody = JSON.stringify({
            limit_daily_redemption: qty,
        });

        this.setState({ loading: true })
        fetch(URL.urlfour + '/api/donations/'+ details.id, {
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.mainbody}>
                        ...
                        <View style={styles.textInputContainer}>
                            <Text style={styles.actionbutton}>Set Limit,  current limit ({details.limit_daily_redemption})</Text>
                        ...
                        <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#4b47b7', '#0f0e43']} style={styles.buttonContainer} block iconLeft>
                            <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }} onPress={() => this.setState({ pin: true })} >
                                <Text style={{ fontFamily: 'Poppins-SemiBold', color: '#fdfdfd', fontSize: 14 }}>Update Limits</Text>
                            </TouchableOpacity>
                        </LinearGradient>
