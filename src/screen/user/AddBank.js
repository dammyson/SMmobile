...
import { Alert, SafeAreaView, TextInput, ImageBackground, Dimensions, StyleSheet, StatusBar, Image, TouchableOpacity, AsyncStorage } from 'react-native';
...
export default class AddBank extends Component {
  ...
  addBankProcess() {
    ...
    const { bank_name, bank_code, account_number, account_name, wallet, data } = this.state
  ...
  getBeneficiaryProcess(text) {
    ...
    const { bank_code, account_number, data } = this.state
        ...
        <View style={styles.body}>
          ...
          <View style={styles.mainbody}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center', marginHorizontal: 15, }} >
              ...
              <Text style={{ fontSize: 13, marginTop: 10, color: '#3E3E3E', textAlign: 'center', fontFamily: 'Poppins-Light', marginHorizontal: 15, }}>
                You can’t edit or delete YOUR Bank account once added. Make sure the details are correct.
</Text>
            </View>
